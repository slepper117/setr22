...
void setup() { 
  ...
  Serial.println("Transistor base set to pin "+ String (powerControl, DEC)); //pin 10 to Servo signal line
...
void loop() {
  ...
  ****************************************/
  // turn off servo power
  digitalWrite (powerControl, LOW); Serial.println("Servo Power is OFF");
  
  //turn off the pwm signal to the servo servo.detach();
  Serial.println("Servo detached");
